...
export function openStudioDb(path) {
  ...
  db.exec(`CREATE TABLE IF NOT EXISTS schema_meta (key TEXT PRIMARY KEY, value TEXT NOT NULL);
    ...
    CREATE TABLE IF NOT EXISTS studio_tasks (id TEXT PRIMARY KEY, version_id TEXT NOT NULL REFERENCES versions(id), stage_key TEXT NOT NULL, name TEXT NOT NULL, agent_role TEXT NOT NULL, task_type TEXT NOT NULL DEFAULT 'document', status TEXT NOT NULL, format TEXT NOT NULL DEFAULT 'md', output_name TEXT NOT NULL, acceptance TEXT, artifact_id TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, UNIQUE(version_id, output_name));
