...
export function openStudioDb(path) {
  ...
  db.exec(`CREATE TABLE IF NOT EXISTS schema_meta (key TEXT PRIMARY KEY, value TEXT NOT NULL);
    ...
    CREATE TABLE IF NOT EXISTS stages (id TEXT PRIMARY KEY, version_id TEXT NOT NULL REFERENCES versions(id), stage_key TEXT NOT NULL, status TEXT NOT NULL, UNIQUE(version_id, stage_key));
